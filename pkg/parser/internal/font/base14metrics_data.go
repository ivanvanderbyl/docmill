// Code generated from the Adobe Core 14 AFM metrics (Adobe Systems Inc.,
// redistributable per the Core 14 AFM licence; values cross-checked against
// pdf.js src/core/metrics.js). DO NOT EDIT.
package font

// base14VerticalMetric carries the AFM header metrics used for the
// face-less GetCharBBox vertical fallback (1000-unit glyph space).
type base14VerticalMetric struct {
	ascender  int    // AFM Ascender (0 when the AFM omits it: Symbol, ZapfDingbats)
	descender int    // AFM Descender (0 when omitted)
	bbox      [4]int // AFM FontBBox: left, bottom, right, top
}

// base14VerticalMetrics is indexed by standardFont.
var base14VerticalMetrics = [14]base14VerticalMetric{
	stdCourier:              {ascender: 629, descender: -157, bbox: [4]int{-23, -250, 715, 805}},
	stdCourierBold:          {ascender: 629, descender: -157, bbox: [4]int{-113, -250, 749, 801}},
	stdCourierBoldOblique:   {ascender: 629, descender: -157, bbox: [4]int{-57, -250, 869, 801}},
	stdCourierOblique:       {ascender: 629, descender: -157, bbox: [4]int{-27, -250, 849, 805}},
	stdHelvetica:            {ascender: 718, descender: -207, bbox: [4]int{-166, -225, 1000, 931}},
	stdHelveticaBold:        {ascender: 718, descender: -207, bbox: [4]int{-170, -228, 1003, 962}},
	stdHelveticaBoldOblique: {ascender: 718, descender: -207, bbox: [4]int{-174, -228, 1114, 962}},
	stdHelveticaOblique:     {ascender: 718, descender: -207, bbox: [4]int{-170, -225, 1116, 931}},
	stdTimes:                {ascender: 683, descender: -217, bbox: [4]int{-168, -218, 1000, 898}},
	stdTimesBold:            {ascender: 683, descender: -217, bbox: [4]int{-168, -218, 1000, 935}},
	stdTimesBoldOblique:     {ascender: 683, descender: -217, bbox: [4]int{-200, -218, 996, 921}},
	stdTimesOblique:         {ascender: 683, descender: -217, bbox: [4]int{-169, -217, 1010, 883}},
	stdSymbol:               {ascender: 0, descender: 0, bbox: [4]int{-180, -293, 1090, 1010}},
	stdDingbats:             {ascender: 0, descender: 0, bbox: [4]int{-1, -143, 981, 820}},
}

// base14Widths returns the glyph-name -> advance-width table (1000-unit glyph
// space) for a Base-14 font, or nil for the fixed-pitch Courier variants
// (uniformly 600, pre-filled by loadType1).
func base14Widths(id standardFont) map[string]uint16 {
	switch id {
	case stdHelvetica:
		return base14WidthsHelvetica
	case stdHelveticaBold:
		return base14WidthsHelveticaBold
	case stdHelveticaBoldOblique:
		return base14WidthsHelveticaBoldOblique
	case stdHelveticaOblique:
		return base14WidthsHelveticaOblique
	case stdTimes:
		return base14WidthsTimesRoman
	case stdTimesBold:
		return base14WidthsTimesBold
	case stdTimesBoldOblique:
		return base14WidthsTimesBoldItalic
	case stdTimesOblique:
		return base14WidthsTimesItalic
	case stdSymbol:
		return base14WidthsSymbol
	case stdDingbats:
		return base14WidthsZapfDingbats
	default:
		return nil
	}
}

var base14WidthsHelvetica = map[string]uint16{
...
var base14WidthsHelveticaBold = map[string]uint16{
...
var base14WidthsHelveticaBoldOblique = map[string]uint16{
	"A": 722, "AE": 1000, "Aacute": 722, "Abreve": 722,
	"Acircumflex": 722, "Adieresis": 722, "Agrave": 722, "Amacron": 722,
	"Aogonek": 722, "Aring": 722, "Atilde": 722, "B": 722,
	"C": 722, "Cacute": 722, "Ccaron": 722, "Ccedilla": 722,
...
var base14WidthsHelveticaOblique = map[string]uint16{
	"A": 667, "AE": 1000, "Aacute": 667, "Abreve": 667,
	"Acircumflex": 667, "Adieresis": 667, "Agrave": 667, "Amacron": 667,
	"Aogonek": 667, "Aring": 667, "Atilde": 667, "B": 667,
	"C": 722, "Cacute": 722, "Ccaron": 722, "Ccedilla": 722,
...
var base14WidthsTimesRoman = map[string]uint16{
...
var base14WidthsTimesBold = map[string]uint16{
	"A": 722, "AE": 1000, "Aacute": 722, "Abreve": 722,
	"Acircumflex": 722, "Adieresis": 722, "Agrave": 722, "Amacron": 722,
	"Aogonek": 722, "Aring": 722, "Atilde": 722, "B": 667,
	"C": 722, "Cacute": 722, "Ccaron": 722, "Ccedilla": 722,
...
var base14WidthsTimesBoldItalic = map[string]uint16{
...
var base14WidthsTimesItalic = map[string]uint16{
...
var base14WidthsSymbol = map[string]uint16{
...
var base14WidthsZapfDingbats = map[string]uint16{
