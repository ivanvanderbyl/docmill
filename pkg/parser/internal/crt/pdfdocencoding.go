// Ported from the kPDFDocEncoding table in
// core/fpdfapi/parser/fpdf_parser_decode.cpp @ pdfium 0db284a42.
//
// PDFDocEncoding maps each of the 256 single-byte codes to its Unicode code
// point, used when decoding a PDF text string that has no UTF-16/UTF-8 BOM.
// This is read-only data; see plan 009 Phase A.
package crt

// pdfDocEncoding is the byte->Unicode map for PDFDocEncoding (Annex D, PDF 1.7).
